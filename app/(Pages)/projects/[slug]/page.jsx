          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 max-w-xl mx-auto Ovo">
                This project link doesn’t match any item in your current project
                list.
              </p>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
              ...
              >
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="relative px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 text-sm inline-flex items-center justify-center gap-2"
                  >
                    <Link
                      href="/#contact"
                      className="absolute inset-0"
              ...
              >
                ...
                <div className="space-y-3 text-sm text-gray-700">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-gray-500 Ovo">Title</span>
                    <span className="font-medium Ovo">{project.title}</span>
                  </div>
                  <div className="flex items-center justify-between gap-4">
