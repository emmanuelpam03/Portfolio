        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-white/90 backdrop-blur-xl border border-gray-200 rounded-3xl shadow-lg p-6">
            ...
            <div className="mt-4 rounded-2xl border border-dashed border-gray-300 bg-gradient-to-r from-blue-50/60 to-purple-50/60 p-6 text-center">
              <p className="text-base text-gray-700 Ovo">Drop files here</p>
              <p className="text-sm text-gray-600 Ovo mt-2">or</p>
              <button
                type="button"
                className="mt-3 px-5 py-2.5 rounded-full border border-gray-200 bg-white text-gray-700 text-base font-medium hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300"
              >
                Browse
              </button>
            </div>
          ...
          <div className="lg:col-span-2 bg-white/90 backdrop-blur-xl border border-gray-200 rounded-3xl shadow-lg p-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <p className="text-sm text-gray-600 Ovo">0 items</p>
            </div>
